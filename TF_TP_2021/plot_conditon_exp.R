...
### P
# conditional on exp
load(paste0(dir_fig,"df_all_P_mid.RData"))
...
# df_all_TP_overall.RData
load(paste0(dir_fig,"df_all_P_overall.RData"))
...
pdf(paste0(dir_fig,"scatter_P_overall.pdf"))
...
# dev.off()
pdf(paste0(dir_fig,"scatter_P_AdiposeSubcutaneous_overall.pdf"),width=5,height=3)
...
load(paste0(dir_fig,"df_all_TP_mid.RData"))
df_all$expression_level="middle"
df_all_=df_all
...
# overall, unconditional on exp
load(paste0(dir_fig,"df_all_TP_overall.RData"))
df_all$expression_level="overall"
# df_all_=df_all
# ls(df_all_)
df_all_=rbind(df_all_,df_all)
...
pdf(paste0(dir_fig,"scatter_TP_overall.pdf"))
# for(tissue_tmp in unique(df_all_$tissue)){
# plot(df_all_[which(df_all_$tissue == tissue_tmp &),])
# }
# for(tissue_tmp in unique(df_all_$tissue)){
...
pdf(paste0(dir_fig,"scatter_TP_AdiposeSubcutaneous_overall.pdf"),width=5,height=3)
# for(tissue_tmp in unique(df_all_$tissue)){
tissue_tmp="Adipose Subcutaneous"
  # plot(df_all_[which(df_all_$tissue == tissue_tmp ),])
  ggplot(df_all_[which(df_all_$tissue == tissue_tmp&as.numeric(df_all_$signal_percent)>0.3 ),], 
