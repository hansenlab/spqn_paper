...
dir_input="/users/ywang/10_25_2019/PPI/data/"
dir_fig="/users/ywang/10_25_2019/PPI/fig/"
dir_input2="/users/ywang/10_25_2019/exp_signal_4PC/data/"
...
#     load(paste0(dir_input,i,"_th_tissue_dist_both_exp_PPI.RData" ))#dist_ave_exp_PPI
#     load(paste0(dir_input,percent_,"_percent_",n_PC,"PCs_",i,"_d0_both.RData"))
#     
#     yrange=range(dist_ave_exp_PPI$y,d0$y)
#     yrange_all_4PC=c(yrange_all_4PC,yrange)
#     xrange=range(dist_ave_exp_PPI$x,d0$x)
...
#   load(paste0(dir_input,percent_,"_percent_",n_PC,"PCs_",i,"_d0_both.RData"))
#   
#   pdf(paste0(dir_fig,"PPI_",i,"_th_tissue_both.pdf"))
#   
#   par(oma = c(0,0,0,0), mar = c(5,5,0.6,0.6))
#   
