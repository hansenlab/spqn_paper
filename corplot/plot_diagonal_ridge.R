...
for(i in 1:9){
  ...
  pdf(paste0(dir_fig,"diagonal_ori_ridge_",n_PC,"PC",i,"th_tissue.pdf"),width=7,height = 7)
...
# load(paste0(dir_output,"cor_est_",n_PC,"_PCs_",i,"th_tissue.RData"))
# pdf(paste0(dir_fig,"diagonal_est_ridge_",n_PC,"PC",i,"th_tissue.pdf"),width=7,height = 7)
# plot_diagonal_ridge(cor_est)
# dev.off()
